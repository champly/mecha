// Source: https://gitlab.com/gnachman/iterm2/-/blob/master/proto/api.proto
// Update: make proto-update
...
type CreateTabRequest struct {
	...
	SelectTab     *bool `protobuf:"varint,6,opt,name=select_tab,json=selectTab" json:"select_tab,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTabRequest) GetSelectTab() bool {
	if x != nil && x.SelectTab != nil {
		return *x.SelectTab
	}
	return false
...
const file_api_proto_rawDesc = "" +
	...
	"\x12minimized_sessions\x18\x06 \x03(\v2\x16.iterm2.SessionSummaryR\x11minimizedSessions\"\x81\x02\n" +
	...
	"\x19custom_profile_properties\x18\x05 \x03(\v2\x17.iterm2.ProfilePropertyR\x17customProfileProperties\x12\x1d\n" +
	"\n" +
	"select_tab\x18\x06 \x01(\bR\tselectTab\"\x94\x02\n" +
	...
	"\x05KITTY\x10\x02B4Z,github.com/champly/mecha/pkg/term/iterm2/api\xa2\x02\x03ITM"
